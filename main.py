...
if __name__ == '__main__':
    ...
    for Nt in range(1, 11, 1):
        for J in [3, 5, 10]:
            ...
            for pow_term in [5, -5, 10, -10, 'est', 'gt']:
                for theta in criteria_power.keys():
                    ...
                    for _ in range(30):
                        ...
                        rec_sm_, pre_sm_, f_beta_sm = sm_run(criteria_num, n_papers, papers_page, J, lr, Nt, acc,
                                                             criteria_power[theta], criteria_difficulty, GT, fr_p_part, pow_term)
    ...
    pd.DataFrame(data, columns=['Nt', 'J', 'lr', 'loss_mean', 'loss_std', 'FPR', 'TPR',
                                ...
                                'pow_term', 'theta']). \
                                to_csv('output/data/power_criteria_experiment2.csv', index=False)
