...
if __name__ == '__main__':
    ...
    for Nt in [1, 2, 3, 4]:
        ...
        for _ in range(10):
            ...
            # Baseline
            loss_b_, rec_b_, pre_b_, f_beta_b, price_b_ = baseline(cj_votes, n_criteria, n_papers, lr, GT)
            ...
            # M-runs
            loss_m_, rec_m_, pre_m_, f_beta_m, price_m_ = m_run(cj_votes, n_criteria, n_papers, lr, GT, fr_p_part)
            ...
            # SM-runs
            loss_sm_, rec_sm_, pre_sm_, f_beta_sm, price_sm_, syn_prop_sm_ = sm_run(cj_votes, n_criteria, n_papers,
